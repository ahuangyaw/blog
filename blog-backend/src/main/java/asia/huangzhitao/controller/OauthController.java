...
import asia.huangzhitao.domain.request.oauth.GiteeBody;
import asia.huangzhitao.domain.request.oauth.GithubBody;
import asia.huangzhitao.enums.RegisterTypeEnum;
