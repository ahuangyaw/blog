    ...
    <Main only-father-container>
      ...
      <template #content>
        ...
        <div class="content">
            ...
            <div class="content_author">
              <div class="author">
                <div class="author_avatar">
                  <img src="http://47.120.42.45:9000/file/fu.png" alt="">
                </div>
          ...
          <div class="item_content" style="margin-bottom: 10rem;margin-top: 5rem">
            <el-divider content-position="left">后续计划</el-divider>
            <div class="content_author">
              <div class="author">
                <div class="author_info">
                  <div class="author_desc">
                    <span>把之前的项目上线，改造微服务</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="item_content">
            <el-divider content-position="left">关于网站</el-divider>
